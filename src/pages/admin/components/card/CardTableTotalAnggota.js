...
export default function CardTableTotalAnggota({ color }){
    return (
        <>
            <div
                className={
            ...
            >
                <div className="rounded-t mb-0 px-4 py-3 border-0">
                    <div className="flex flex-wrap items-center">
                        ...
                        >
                            Laporan Total Anggota Pada Periode <input className="rounded-lg" type="date" name="" id="" /> Sampai <input className="rounded-lg" type="date" name="" id="" />
                        </h3>
                        </div>
                    </div>
                </div>
